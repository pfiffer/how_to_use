%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	PSO (Direct Optimization) METHOD
	SPE-10 Standard Model
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
This code is written to optimize the location of the injection wells using Particle Swarm Optimization coupled with reservoir simualtor (Direct Optimization).
