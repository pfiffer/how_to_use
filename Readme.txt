...
This code is written to optimize the location of the injection wells using Particle Swarm Optimization and Fast Marching Method coupled with reservoir simualtor.
